...
from .serializers import CreateUserSerializer, CustomUser, LoginSerializer, UpdatePasswordSerializer, CustomUserSerializer, UserActivities, UserActiviesSerializer
...
class UserActiviesView(ModelViewSet):
    serializer_class = UserActiviesSerializer
    http_method_names = ["get"]
